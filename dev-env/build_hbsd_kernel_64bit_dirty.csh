...
if ( "X$1" != "X" ) then
	echo "changed KERNCONF to HARDENEDBSD ..."
	set KERNCONF="HARDENEDBSD"
	setenv KERNCONF "HARDENEDBSD"
endif
...
(cd /usr/data/source/git/opBSD/${_current_dir}; make -j$__freebsd_mk_jobs -DNO_ROOT KERNCONF=${KERNCONF} -DNO_CLEAN kernel) |& tee -a ${_log}
