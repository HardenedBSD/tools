...
set ORIGIN_BASED="${ORIGIN_BASED} hardened/current/intel-smap"
set ORIGIN_BASED="${ORIGIN_BASED} hardened/current/paxctl"
set ORIGIN_BASED="${ORIGIN_BASED} hardened/current/segvguard"
set ORIGIN_BASED="${ORIGIN_BASED} hardened/current/upstream"
